...
def index(request):
    ...
    return render(request, 'Owner_index.html', {'worker': worker, 'Message': Message, 'owner': owner,
...
def AllManagers(request):
    ...
    no_of_pending_request = count_pending_book_request()
    return render(request, "All_Managers.html",
                  {'manager': manager, 'owner': owner, 'no_of_pending_request': no_of_pending_request})
...
def AllCustomers(request):
    ...
    return render(request, "All_Customers.html",
                  {'customer': customer, 'owner': owner, 'no_of_pending_request': no_of_pending_request})
...
def Manager_Profile(request, Manager_email):
    ...
    no_of_pending_request = count_pending_book_request()
    return render(request, 'Owner_Manager_Profile.html',
                  {'owner': owner, 'manager': manager, 'no_of_pending_request': no_of_pending_request})
...
def Customer_Profile(request, customer_email):
    ...
    no_of_pending_request = count_pending_book_request()
    return render(request, 'Owner_Customer_Profile.html',
                  {'owner': owner, 'customer': customer, 'no_of_pending_request': no_of_pending_request})
...
def AllWork(request):
    ...
    worker = Worker.objects.all()
    no_of_pending_request = count_pending_book_request()
    return render(request, "Owner_all_workers.html",
                  {'worker': worker, 'owner': owner, 'no_of_pending_request': no_of_pending_request})
...
def showdetails(request, Worker_work_profile_id):
    ...
    owner = Owner.objects.get(Owner_email=owner_email)
    no_of_pending_request = count_pending_book_request()
    return render(request, 'Owner_showdetails.html',
                  {'worker': worker, 'owner': owner, 'no_of_pending_request': no_of_pending_request})
...
def CheckAvailability(request, Worker_work_profile_id):
    ...
    if BookWorker_Date_of_Booking < date.today():
        ...
        return render(request, 'Owner_showdetails.html',
                      {'Incorrect_dates': Incorrect_dates, 'worker': worker, 'owner': owner,
                       'no_of_pending_request': no_of_pending_request})
    ...
    book_data = {"BookWorker_Date_of_Booking": BookWorker_Date_of_Booking,
                 "BookWorker_Date_of_Return": BookWorker_Date_of_Return, "days": days, "total": total}
    ...
    for rv in bookworker:
        ...
        if (
                rv.BookWorker_Date_of_Booking >= BookWorker_Date_of_Booking and BookWorker_Date_of_Return >= rv.BookWorker_Date_of_Booking) or (
                BookWorker_Date_of_Booking >= rv.BookWorker_Date_of_Booking and BookWorker_Date_of_Return <= rv.BookWorker_Date_of_Return) or (
                BookWorker_Date_of_Booking <= rv.BookWorker_Date_of_Return and BookWorker_Date_of_Return >= rv.BookWorker_Date_of_Return):
            if rv.isAvailable:
                Available = True
                Message = "Note that somebody has also requested for this worker from " + str(
                    rv.BookWorker_Date_of_Booking) + " to " + str(rv.BookWorker_Date_of_Return)
                return render(request, 'Owner_showdetails.html',
                              {'Message': Message, 'Available': Available, 'worker': worker, 'owner': owner,
                               'book_data': book_data, 'no_of_pending_request': no_of_pending_request})

            NotAvailable = True
            return render(request, 'Owner_showdetails.html',
                          {'NotAvailable': NotAvailable, 'dates': rv, 'worker': worker, 'owner': owner,
                           'no_of_pending_request': no_of_pending_request})

    Available = True
    return render(request, 'Owner_showdetails.html',
                  {'Available': Available, 'worker': worker, 'owner': owner, 'book_data': book_data,
                   'no_of_pending_request': no_of_pending_request})
...
def BookRequest(request):
    ...
    no_of_pending_request = count_pending_book_request()
    return render(request, 'Owner_BookRequest.html',
                  {'owner': owner, 'bookworker': bookworker, 'no_of_pending_request': no_of_pending_request})
...
def SentRequests(request):
    ...
    if bookworker.exists():
        worker = Worker.objects.all()
        return render(request, 'Owner_SentRequests.html', {'owner': owner, 'bookworker': bookworker, 'worker': worker,
                                                           'no_of_pending_request': no_of_pending_request})
    else:
        Message = "You haven't made any worker request yet!!"
        return render(request, 'Owner_SentRequests.html', {'owner': owner, 'bookworker': bookworker, 'Message': Message,
                                                           'no_of_pending_request': no_of_pending_request})
